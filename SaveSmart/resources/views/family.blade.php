    ...
    <div class="max-w-md mx-auto bg-white p-8 rounded-lg border border-gray-200">
        ...
        <form id="login-form" action="/validateprofile" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="password" name="password" id="profilePassword" required class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Enter password"/>
            </div>
...
<div id="add-profile-form" class="min-h-screen container mx-auto px-4 py-16 hidden">
    ...
    <div class="flex justify-center mb-12">
        <div class="flex items-center gap-2">
            ...
            <span class="font-bold text-xl">Create a new profile</span>
        </div>
    </div>

    <div class="max-w-md mx-auto bg-white p-8 rounded-lg border border-gray-200">
        <h2 class="text-2xl font-semibold mb-6 text-center">Enter the informations</h2>

        <form id="login-form" action="/createprofile" method="POST">
            @csrf
            <input type="hidden" name="id" id="familyId"/>

            <div class="mb-6">
                <label for="profileName" class="block text-gray-700 mb-2">Name</label>
                <input type="text" name="name" id="profilePassword" required class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Enter name"/>
            </div>
            <div class="mb-6">
                <label for="profilePassword" class="block text-gray-700 mb-2">Password</label>
                <input type="password" name="password" id="profilePassword" required class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Enter password"/>
